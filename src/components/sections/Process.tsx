  ...
  return (
    <Section id="processo" className="border-b border-white/10 bg-[#080808] scroll-mt-24">
      ...
      <ol className="relative mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-5">
        <span
          className="pointer-events-none absolute left-0 right-0 top-8 hidden h-px bg-gradient-to-r from-primary/35 via-white/12 to-primary/20 lg:block"
          aria-hidden="true"
        />
        ...
        {processSteps.map((step) => {
          ...
          return (
            <li key={step.id} className="relative">
              <article className="group flex h-full gap-4 rounded-3xl border border-border bg-card p-5 text-card-foreground transition duration-300 hover:-translate-y-1 hover:border-primary/45 hover:bg-secondary md:flex-col">
                <div className="relative flex shrink-0 flex-col items-center md:items-start">
                  ...
                  <span className="mt-3 hidden h-full w-px bg-border md:hidden" aria-hidden="true" />
                </div>
